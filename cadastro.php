...
<body>
    ...
    <div class="formulario">
        <form method="POST" action="scadastro.php">
            <label for="fid">Nome de usuário:</label>
            <input type="text" id="fusuario" name="usuario" minlength="4" maxlength="15" autofocus required><br><br>
            ...
            <label for="frepita">Repita a senha:</label>
